...
// Web Geolocation detection with OpenStreetMap Nominatim fallback geocoding
async function detectWebLocation() {
    ...
    navigator.geolocation.getCurrentPosition(async (position) => {
        ...
        try {
            // Fetch reverse geocode address from OSM Nominatim Api
        ...
        if (error.code === error.PERMISSION_DENIED) {
            errMsg = "Location access was denied. Please enable browser location permissions for this portal.";
        }
        alert(errMsg);
        icon.className = "fa-solid fa-location-arrow";
        text.textContent = "Locate Me";
